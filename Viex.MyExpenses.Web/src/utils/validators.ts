 ...
 */
export const isNullOrWhitespace = (value: string): boolean => isNull(value) || value.trim().length == 0;
 ...
 */
export const notNullNorWhitespace = (value: string): boolean => !isNullOrWhitespace(value);
